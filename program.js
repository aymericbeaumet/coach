...
export const WARMUP = {
  ...
  exercises: [
    ...
    { name: 'Suspension passive à la barre', weight: '', reps: '45 sec', detail: 'on relâche tout — épaules aux oreilles, dos qui s\'allonge', sets: 1, seconds: 45, video: '2vspW4N4BMs' },
...
export const PROGRAM = {
  A: {
    ...
    exercises: [
      ...
      { block: 'Triplet 1 — 4 tours enchaînés', name: 'Pompes lentes', weight: '', reps: '4 × 5 reps', detail: '3 s de descente — pieds surélevés dès que les 5 reps sont faciles', sets: 4, video: 'WDIpL0pjun0' },
      ...
      { block: 'Triplet 2 — 4 tours enchaînés', name: 'Isométrie pompe', weight: '', reps: '4 × 30 sec', detail: 'coudes à 90° — le tendon', sets: 4, seconds: 30, video: 'Jv2hgtdfcC8' },
  ...
  B: {
    ...
    estimatedMinutes: 17,
    exercises: [
      { block: 'Triplet 1 — 4 tours enchaînés', name: 'Traction', weight: '', reps: '4 × 3 reps', detail: '3 reps propres, jamais plus — si la traction ne vient pas : négative de 5 s', sets: 4, video: 'DGSm56-FixA' },
      ...
      { block: 'Triplet 2 — 4 tours enchaînés', name: 'Rowing australien', weight: '', reps: '4 × 8 reps', detail: 'sous une table, corps gainé, 2 s de tenue en haut', sets: 4, video: 'KOaCM1HMwU0' },
      { block: 'Triplet 2 — 4 tours enchaînés', name: 'Planche latérale', weight: '', reps: '30 sec (on change de côté à chaque tour)', detail: 'hanche haute, épaules et bassin alignés', sets: 4, seconds: 30, video: '0M-erHBl48U' },
  ...
  C: {
    ...
    exercises: [
      ...
      { block: 'Triplet 1 — 4 tours enchaînés', name: 'Hollow hold', weight: '', reps: '4 × 25 sec', detail: 'lombaire collé au sol', sets: 4, seconds: 25, video: 'ytenqCqCIyU' },
      ...
      { block: 'Triplet 2 — 4 tours enchaînés', name: 'Relevé de genoux suspendu', weight: '', reps: '4 × 6 reps', detail: 'sans balancer — montée lente, descente encore plus lente', sets: 4, video: 'G6a5267YpHM' },
