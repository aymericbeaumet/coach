...
export const PROGRAM = {
  ...
  B: {
    ...
    exercises: [
      ...
      { block: 'Triplet 2 — 4 tours enchaînés', name: 'Rowing australien', weight: 'Poids du corps', reps: '4 × 8 reps', detail: 'sous une table — on tire avec les omoplates, jamais avec le cou. 2 s de tenue en haut', sets: 4, video: 'KOaCM1HMwU0' },
